...
import me.shaftesbury.codegenerator.model.IMethodName;
...
public class MethodInvocationUtilsProxy {
    public Option<Exception> invokeTestMethod(final IExecutionContext executionContext, final IClassName testClassName, final IMethodName testMethodName) {
