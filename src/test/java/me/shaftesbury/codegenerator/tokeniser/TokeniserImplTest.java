...
//    }
    ...
    void simplestClass() {
        ...
        new TokeniserImpl().visit(cu, tokens);
    ...
    void simpleClassWithSimpleConstructor() {
        ...
        assertThat(tokens).containsExactly(PUBLIC, CLASS, ClassName.of("A"), STARTCLASS, PUBLIC, FunctionName.of("A"), STARTFUNCTIONPARAMETERS, ENDFUNCTIONPARAMETERS, STARTFUNCTION, INT, Reference.of("i"), ASSIGNMENT, Value.of(1), SEMICOLON, ENDFUNCTION, ENDCLASS);
    }
